...
function ResumeDocument({ compact = false }) {
  return (
    <div className={`resume-doc ${compact ? 'compact' : ''}`}>
      ...
      <h3 className="resume-doc-h">Experience (Internships)</h3>
      {resumeDoc.internships.map((p) => (
  ...
  return (
    <section id="resume" ref={ref} className="section-shell tight resume-section">
      ...
      <div className="rc-grid">
        <div className="rc-panel liquid-card reveal">
          ...
          <div className="resume-meta">
            ...
            <p>{profile.title}</p>
            <p className="resume-degree">B.E. in Mechanical Engineering, St. Joseph's Institute of Technology</p>
            <LiquidResumeButton
        ...
        <div className="pdf-modal" onClick={() => setPreviewOpen(false)}>
          <div className="pdf-modal-inner" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="pdf-modal-body">
              <iframe src={profile.resumeFile} title={`${profile.fullName} — Resume`} className="pdf-modal-iframe" />
            </div>
          </div>
        </div>
      )}
      ...
      <style>{`
        ...
        .pdf-modal-inner{ position:relative; width:100%; max-width:1100px; max-height:95vh; background:var(--paper); border-radius:16px; overflow:hidden; display:flex; flex-direction:column; box-shadow:0 30px 80px rgba(0,0,0,0.5); }
        .pdf-modal-head{
        ...
        .pdf-modal-iframe{ width:100%; height:85vh; border:0; border-radius:8px; background:var(--paper); }
